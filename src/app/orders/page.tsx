...
export default async function OrdersPage() {
  ...
  if (!session?.user?.id) {
    return <div className="container mx-auto py-8">Debes iniciar sesión para ver tus órdenes.</div>
  }
  ...
  if (orders.length === 0) {
    return <div className="container mx-auto py-8">No tienes órdenes aún.</div>
  }
